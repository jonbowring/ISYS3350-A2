    ...
    public static final Scanner scan = new Scanner (System.in);
	  ...
	  public static void main (String[]args)
	  {
		...
		switch (choice)
		  {
		  	case "a":
		  		PepSystem purchaseTicket = new PepSystem();
		    	PepSystem.Ticket newTicket = purchaseTicket.new Ticket(UUID.randomUUID().toString(), 0, null);
		    ...
		    break;
		    case "c": 
		    	PepSystem addCredit = new PepSystem();
		    	PepSystem.Ticket ticket = addCredit.new Ticket(UUID.randomUUID().toString(), 0, null);
		    	ticket.addCredit();
		    break;
		...
		//	  this.history = history;
			...
			public void addCredit() {
				if (validateCredit() == true) {
					...
					credit = input;
					System.out.println ("$" + credit + " added to your ticket ID = " + getId());
					scan.close();
